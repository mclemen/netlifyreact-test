      ...
      <nav role="navigation">
        <div class="container">
          ...
          <div class="navbar-menu">
            <div>
              <LinkWithStatus state={state} to="/">
                Home
              </LinkWithStatus>
              <LinkWithStatus state={state} to="/project">
                The project
              </LinkWithStatus>
              <LinkWithStatus state={state} to="/news">
                News
              </LinkWithStatus>
              <LinkWithStatus state={state} to="/starter">
                Quick start{" "}
              </LinkWithStatus>
              <LinkWithStatus state={state} to="/counter">
                Counter
              </LinkWithStatus>
              <LinkWithStatus state={state} to="/heros">
                Heros
              </LinkWithStatus>
              <LinkWithStatus state={state} to="/apod">
                APOD
              </LinkWithStatus>
            </div>
          </div>
